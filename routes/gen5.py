...
def fetch_gen5_pokemon_from_api():
    ...
    for pokemon_id in range(494, 650):  # Gen 5 IDs
        try:
...
def save_to_json(pokemon_data, json_filename="pokeJsons/gen5output.json"):
...
def get_gen5_pokemon_data(json_filename="pokeJsons/gen5output.json"):
    if os.path.exists(json_filename):
        try:
            ...
            data = fetch_gen5_pokemon_from_api()
...
def regenerate_json_file(json_filename="pokeJsons/gen5output.json"):
