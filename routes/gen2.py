...
def fetch_gen2_pokemon_from_api():
    ...
    for pokemon_id in range(152, 252):  # Gen 2 IDs
        try:
...
def save_to_json(pokemon_data, json_filename="pokeJsons/gen2output.json"):
...
def get_gen2_pokemon_data(json_filename="pokeJsons/gen2output.json"):
    """Load Gen 2 Pokémon data from JSON, or fetch from API if needed."""
...
def regenerate_json_file(json_filename="pokeJsons/gen2output.json"):
