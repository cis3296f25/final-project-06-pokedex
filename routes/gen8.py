...
def fetch_gen8_pokemon_from_api():
    ...
    for pokemon_id in range(810, 999):  # Gen 8 IDs
        try:
...
def save_to_json(pokemon_data, json_filename="pokeJsons/gen8output.json"):
...
def get_gen8_pokemon_data(json_filename="pokeJsons/gen8output.json"):
    if os.path.exists(json_filename):
        try:
            ...
            data = fetch_gen8_pokemon_from_api()
...
def regenerate_json_file(json_filename="pokeJsons/gen8output.json"):
