...
def save_to_json(pokemon_data, json_filename="../pokeJsons/gen1output.json"):
...
# You can also add this to force regenerate the JSON file if needed
def regenerate_json_file(json_filename="pokeJsons/gen1output.json"):
