...
def fetch_gen7_pokemon_from_api():
    ...
    for pokemon_id in range(722, 810):  # Gen 7 IDs
        try:
...
def save_to_json(pokemon_data, json_filename="pokeJsons/gen7output.json"):
...
def get_gen7_pokemon_data(json_filename="pokeJsons/gen7output.json"):
    if os.path.exists(json_filename):
        try:
            ...
            data = fetch_gen7_pokemon_from_api()
...
def regenerate_json_file(json_filename="pokeJsons/gen7output.json"):
